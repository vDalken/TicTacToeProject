...
public class SystemOut {
    ...
    public static void printPlaceToPlayError() {
        System.out.println("That position doesn't exist, try another one");
    }
    ...
    public static void printPlayerTurn(Player player, String letter, String round) {
        ...
        if (!(player.getNumberOfRoundVictories() == 0)) {
            System.out.println("Rounds won: " + player.getNumberOfRoundVictories());
        }
    }
    ...
    public static void printPlayerWinningRoundAnnouncement(Player player, int round) {
        System.out.println(player.getGameName() + " won round " + round + "\n");
    }
    ...
    public static void printQuestionAboutPlayers(){
        System.out.println("Are the same players from before still going to play? (write yes or no)");
    }
